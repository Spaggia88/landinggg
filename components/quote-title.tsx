      ...
      <div className="min-h-full w-full max-w-xl mx-auto flex flex-col justify-start px-4 sm:px-6 pt-36 pb-20 lg:py-20">
        <div className="grow flex flex-col justify-center">
          ...
          <div className="space-y-3">
            <div className="font-caveat text-3xl text-blue-500">personalisation & privacy</div>
            <h1 className="h1 font-orbiter font-bold text-white">{title}</h1>
            <time className="block font-caveat text-xl text-slate-400 before:content-['—_']"> <a href="https://discord.gg/Qn6ZmecTEw" target="_blank">join discord</a></time>
          </div>
